...
class DichVu extends Model
{
    ...
    //         $dich_vu->maDV = str_pad($codeNumber, 6, '0', STR_PAD_LEFT);
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (request()->hasFile('anh')) {
                $image = request()->file('anh');
                $image->storeAs("public/images/service_pic/$proId", $model->anh);
            } else {
                $sourcePath = 'public/images/service_pic/defaultavt.png';
                $destinationDirectory = "public/images/service_pic/$proId";
