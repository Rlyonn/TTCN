...
<form action="{{route('login')}}" method="POST">
  ...
  <div class="relative min-h-screen sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
    <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
      <div class="self-start hidden lg:flex flex-col  text-gray-100">
        
        <h1 class="my-3 font-semibold text-4xl">Welcome back</h1>
        <p class="pr-3 text-sx opacity-75">Known as the Island in the heart of Nha Trang city, Champa Island Nha Trang - Resort Hotel & Spa has the most luxurious, unique and fascinating Cham’s architectures. Here, we provide a full range of services, such as accommodation, food & beverage, entertainment, conventions, MICE, private beach, etc. that will fully satisfy our guests. </p>
      </div>
    </div>
    <div class="flex justify-center self-center  z-10">
      <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
        <div class="mb-7">
          ...
          <p class="text-gray-400">Don't have an account? <a href="{{route('show-registration')}}"
              class="text-sx text-blue-700 hover:text-blue-700">Sign Up</a></p>
        </div>
        <div class="space-y-6">
          <div class="">
            <input class=" w-full text-sx  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-blue-400" type="email" name="email" placeholder="Email">
                </div>
            <div class="relative" x-data="{ show: true }">
              <input placeholder="Password" name="matKhau" :type="show ? 'password' : 'text'" class="text-sx text-gray-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-blue-400">
              <div class="flex items-center absolute inset-y-0 right-0 mr-3  text-sx leading-5">
            ...
            <div>
              <input type="submit" name="login" value="Login" class="w-full flex justify-center bg-blue-800  hover:bg-blue-700 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">
            ...
            <div class="flex justify-center gap-5 w-full ">
              ...
              <button type="submit" class="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-900 hover:bg-gray-900 text-sx text-gray-500 p-3  rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500">
              ...
              <button type="submit" class="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-900 hover:bg-gray-900 text-sx text-gray-500 p-3  rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500 px-">
