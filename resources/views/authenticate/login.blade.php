...
<form action="{{route('login')}}" method="POST">
  @csrf
  <div
	class="bg-purple-700 absolute top-0 left-0 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 bottom-0 leading-5 h-full w-full overflow-hidden">
  </div>
  <div class="relative min-h-screen sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
    <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
      <div class="self-start hidden lg:flex flex-col  text-gray-300">
        ...
        <p class="pr-3 text-sx opacity-75">Lorem ipsum is placeholder text commonly used in the graphic, print,
      ...
      <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
        <div class="mb-7">
          ...
          <p class="text-gray-400">Don't have an account? <a href="{{route('show-registration')}}"
              class="text-sx text-purple-700 hover:text-purple-700">Sign Up</a></p>
        </div>
        <div class="space-y-6">
          <div class="">
            <input class=" w-full text-sx  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="email" name="email" placeholder="Email">
                </div>
            <div class="relative" x-data="{ show: true }">
              <input placeholder="Password" name="matKhau" :type="show ? 'password' : 'text'" class="text-sx text-gray-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
            ...
            <div>
              <input type="submit" name="login" value="Login" class="w-full flex justify-center bg-purple-800  hover:bg-purple-700 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">
