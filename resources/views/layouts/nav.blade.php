    ...
    <nav class="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <a href="{{ route('cartIndex') }}" type="button" class="cursor-pointer duration-300 border boder-gray-500 rounded-full hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-4 py-2 text-center">
                    <div class="flex items-center justify-center">
                        <div class="relative scale-75">
                          ...
                          <span class="absolute -top-2 left-4 rounded-full bg-red-500 p-0.5 px-2 text-sm text-red-50">{{ !empty($cart) ? count($cart) : '0'}}</span>
                        </div>
                      </div>
                </a>
