                            ...
                            <li>
                                ...
                                <div class="hidden block list-dropdown">
                                    <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                        <li>
                                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                                href="{{ route('hoa_dons.index') }}">Xem Hoá Đơn</a>
                                        </li>
                                        <li>
                                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                ...
                <div class="flex flex-grow items-center justify-end py-4 px-4 shadow-2">
                    <div class="relative" id="dropdown">
                        ...
                        <div id="dropdown-content"
                            ...
                            <a href="" class="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
