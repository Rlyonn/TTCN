            ...
            <div class="p-0 overflow-x-auto">
                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                    ...
                    <tr>
                        ...
                        <td class="w-12 h-6 text-gray-800 dark:text-white flex items-center">
                            <form class="inline-block mr-1" action="{{ route('loai_dich_vus.destroy', $ldv->maLoaiDV) }}" method="post" id="deleteForm{{$ldv->maLoaiDV}}">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="delete-btn" data-type-service-id="{{ $ldv->maLoaiDV }}">
                                    <img src="/storage/images/icon/delete.png" alt="Delete Icon" class="icon-image">
                                </button>
                            </form>
